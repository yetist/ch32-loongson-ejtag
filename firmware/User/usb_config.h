...
// This is not required for CH32V203F6P6, but because I copied the CherryUSB code from my HPM code
// I need this macro be defined to make descriptor fetching works
// Also if someone uses a CH32 with HSUSB, this makes it painless to port
